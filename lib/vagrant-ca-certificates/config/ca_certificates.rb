  ...
  module CaCertificates
    module Config
      class CaCertificates < Vagrant.plugin('2', :config)
        ...
        attr_accessor :trust_bundle_path
        ...
        def finalize!
          ...
          @trust_bundle_path = nil if @trust_bundle_path == UNSET_VALUE
          @omnibus_path = '/opt/chef' if @omnibus_path == UNSET_VALUE
        end
      end
    end
  end
